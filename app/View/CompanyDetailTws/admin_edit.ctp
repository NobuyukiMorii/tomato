<div class="companyDetailTws form">
<?php echo $this->Form->create('CompanyDetailTw'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Company Detail Tw'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CompanyDetailTw.company_detail_id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('CompanyDetailTw.company_detail_id')))); ?></li>
