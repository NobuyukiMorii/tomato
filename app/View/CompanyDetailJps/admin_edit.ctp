...
<?php echo $this->Form->create('CompanyDetailJp'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Company Detail Jp'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CompanyDetailJp.company_detail_id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('CompanyDetailJp.company_detail_id')))); ?></li>
