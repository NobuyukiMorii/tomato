<div class="users index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('user_facebook_login_id'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($user['User']['user_profile_id']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['user_facebook_login_id']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['user_name']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['email']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['password']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['reported_count']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['user_admin_id']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['created_date']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['updated_date']); ?>&nbsp;</td>
