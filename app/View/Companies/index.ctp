<div class="companies index">
	...
	<tr>
		...
		<td><?php echo h($company['Company']['company_detail_id']); ?>&nbsp;</td>
		<td><?php echo h($company['Company']['created_date']); ?>&nbsp;</td>
		<td><?php echo h($company['Company']['updated_data']); ?>&nbsp;</td>
		<td><?php echo h($company['Company']['del_flg']); ?>&nbsp;</td>
		<td class="actions">
