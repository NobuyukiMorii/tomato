<div class="categories index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('name_tw'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($category['Category']['name_tw']); ?>&nbsp;</td>
		<td><?php echo h($category['Category']['name_jp']); ?>&nbsp;</td>
		...
		<td><?php echo h($category['Category']['del_flg']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $category['Category']['category_id']), array('confirm' => __('Are you sure you want to delete # %s?', $category['Category']['category_id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
