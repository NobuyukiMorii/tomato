<?php
App::uses('CompanyMemberDetailEnsController', 'Controller');

/**
 * CompanyMemberDetailEnsController Test Case
 */
class CompanyMemberDetailEnsControllerTest extends ControllerTestCase {
