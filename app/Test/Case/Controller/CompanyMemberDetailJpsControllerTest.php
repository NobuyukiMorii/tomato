<?php
App::uses('CompanyMemberDetailJpsController', 'Controller');

/**
 * CompanyMemberDetailJpsController Test Case
 */
class CompanyMemberDetailJpsControllerTest extends ControllerTestCase {
