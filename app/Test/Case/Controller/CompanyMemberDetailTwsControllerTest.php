<?php
App::uses('CompanyMemberDetailTwsController', 'Controller');

/**
 * CompanyMemberDetailTwsController Test Case
 */
class CompanyMemberDetailTwsControllerTest extends ControllerTestCase {
