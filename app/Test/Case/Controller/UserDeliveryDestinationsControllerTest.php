<?php
App::uses('UserDeliveryDestinationsController', 'Controller');

/**
 * UserDeliveryDestinationsController Test Case
 */
class UserDeliveryDestinationsControllerTest extends ControllerTestCase {
