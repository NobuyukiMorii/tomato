<?php
App::uses('UserFacebookLoginInfosController', 'Controller');

/**
 * UserFacebookLoginInfosController Test Case
 */
class UserFacebookLoginInfosControllerTest extends ControllerTestCase {
